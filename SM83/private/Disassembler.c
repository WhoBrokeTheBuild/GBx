...
uint16_t SM83_Disassemble(sm83_t * cpu, char * str, size_t len, uint16_t addr)
{
    ...
    static const char * instructionDefinitions[] = {
        [0xCB] = "",
        // misc
        [0x00] = "NOP",
        [0x76] = "HALT",
    ...
    static const char * CBInstructionDefinitions[] = {
        // rotate
        [0x00] = "RLC B",
        [0x01] = "RLC C",
        [0x02] = "RLC D",
    ...
    static const char * bitInstructionDefinitions[] = {
        "BIT !b, B",
        "BIT !b, C",
        "BIT !b, D",
        "BIT !b, E",
    ...
    if (op == 0xCB) {
        ...
        if (op < 0x40) {
            pch = CBInstructionDefinitions[op];
        }
        else {
            uint8_t tmp = op - 0x40;
            // 0-7
            ...
            // 0-7
            int variant = tmp % 8;
            pch = bitInstructionDefinitions[(inst * 8) + variant];
        }
    }
    else {
